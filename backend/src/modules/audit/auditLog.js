...
const AuditActions = {
  ...
  LEARNING_PATH_SUBMITTED:  'LEARNING_PATH_SUBMITTED',
  LEARNING_PATH_PUBLISHED:  'LEARNING_PATH_PUBLISHED',
  LEARNING_PATH_DUPLICATED: 'LEARNING_PATH_DUPLICATED',
  ASSIGNMENT_CREATED:    'ASSIGNMENT_CREATED',
  ASSIGNMENT_COMPLETED:  'ASSIGNMENT_COMPLETED',

  // Progress & completion
  PROGRESS_EVENT_RECORDED: 'PROGRESS_EVENT_RECORDED',
  ASSET_COMPLETED:         'ASSET_COMPLETED',

  // SCORM runtime
  SCORM_SESSION_STARTED:    'SCORM_SESSION_STARTED',
  SCORM_SESSION_COMMITTED:  'SCORM_SESSION_COMMITTED',
  SCORM_SESSION_TERMINATED: 'SCORM_SESSION_TERMINATED',
